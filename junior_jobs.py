...
# ---------------------------------------------------------------------------
# JobsPipe (restored with the original filters)
# ---------------------------------------------------------------------------
...
def main():
    ...
    print(f"Filtered: {skipped_exp} over-exp, {len(new_jobs)} new sent.")
    ...
    send_telegram(f"🔍 <b>{len(new_jobs)} dev job(s) matching your profile today:</b>")
